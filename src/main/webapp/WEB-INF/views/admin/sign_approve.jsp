...
<%
    if (request.getAttribute("approveInfo") != null) {
%>
<script>
    alert("${approveInfo}");
</script>
...
%>
    ...
    <script>
        new Table({
            ...
            ajaxData: { //ajax请求的参数
                url: '${website}admin/listSignInfoWaitingApprove',
                method: 'post',
